      ...
      <div ref={cardRef} className="bg-[#1a1a1a] text-white aspect-[3/4.2] rounded-xl overflow-hidden relative shadow-2xl border-2 border-yellow-400/20">
          ...
          <div className="relative w-full h-full flex flex-col p-1">
            <div className='flex-grow flex'>
              ...
              <div className="w-3/5 h-full flex flex-col justify-center text-left p-4 space-y-4">
                  <div>
                  ...
                  <div className="space-y-2">
                      <p className="font-body text-yellow-400/80 text-sm uppercase tracking-wider">Sold To:</p>
                      <div className="flex items-center gap-3">
                          <Avatar className="h-16 w-16 border-2 border-yellow-400/30 bg-black/50">
                              <AvatarImage src={team.logo} alt={team.name} className="p-1 object-contain"/>
                              <AvatarFallback className="bg-transparent">{team.name.charAt(0)}</AvatarFallback>
                          </Avatar>
                  ...
                  <div>
                      <p className="font-body text-yellow-400/80 text-sm uppercase tracking-wider">Final Bid Amount</p>
